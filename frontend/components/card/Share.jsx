...
const Share = ({ title = "Check out this post" }) => {
  const getShareData = () => {
  ...
  return (
    <div className="flex h-auto w-20 flex-col items-center justify-center gap-4 rounded-2xl bg-primary px-12 py-4 shadow-[0_2px_2px_rgba(0,0,0,0.08)]">
