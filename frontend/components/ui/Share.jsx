...
const Share = () => {
  return (
    <>
      <div className="flex bg-white w-full md:w-20 h-20 md:h-auto rounded-2xl px-6 py-4 flex-row md:flex-col items-center justify-center gap-4 shadow-[0_2px_2px_rgba(0,0,0,0.08)]">
